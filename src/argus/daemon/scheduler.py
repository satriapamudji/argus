...
class ArgusDaemon:
    ...
    def _setup_jobs(self) -> None:
        ...
        if health_ping_minutes > 0:
            ...
            logger.info(f"Scheduled {JOB_HEALTH_PING}: every {health_ping_minutes} minutes")"""Main daemon scheduler for Argus.
...
class ArgusDaemon:
    ...
    def _setup_jobs(self) -> None:
        ...
        if health_ping_minutes > 0:
            ...
            logger.info(f"Scheduled {JOB_HEALTH_PING}: every {health_ping_minutes} minutes")    # Crypto Daily job - daily at configured time (UTC)
