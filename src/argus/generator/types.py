...
class LLMGeneratedContent:
    ...
    The LLM generates narrative text using [#A1B2C3D4] cite keys.
    """
    ...
    # Opening line for monday_preview mode (e.g., "Hope you had a good weekend...")
    opening_line: Optional[str] = None

    # Sign-off paragraph for weekend_wrap mode (e.g., "Have a good weekend...")
