...
## Goal
Create the initial Python codebase, CLI entrypoint, and config loading needed to run Argus on a VM.
...
## Scope
- Create a Python project skeleton and a `bin/argus` CLI with `run --stream ... --mode ...`.
